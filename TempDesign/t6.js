...
function generatePDF(data, images) {
    ...
    doc.image(images.Simg3[0].buffer, parseInt(data.s3x), parseInt(data.s3y), { fit: [100, 100] });
    ...
    doc.image(images.Limg3[0].buffer, parseInt(data.L3x), parseInt(data.L3y), { fit: [90, 90] });
